...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxSecurityLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>crypto</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class MlkitLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>summarization</b> with <b>com.google.mlkit:genai-summarization</b> coordinates and
         * with version reference <b>mlkit.summarization</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSummarization() {
            return create("mlkit.summarization");
        }
    ...
    public static class MlkitEntityLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>mlkit.entity.extraction</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>crypto</b> with value <b>1.1.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MlkitVersionAccessors extends VersionFactory  {
        ...
        private final MlkitEntityVersionAccessors vaccForMlkitEntityVersionAccessors = new MlkitEntityVersionAccessors(providers, config);
        public MlkitVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>mlkit.summarization</b> with value <b>1.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSummarization() { return getVersion("mlkit.summarization"); }
        ...
        /**
         * Group of versions at <b>versions.mlkit.entity</b>
         */
        public MlkitEntityVersionAccessors getEntity() {
            return vaccForMlkitEntityVersionAccessors;
        }
    ...
    public static class MlkitBarcodeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mlkit.barcode.scanning</b> with value <b>17.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MlkitDigitalVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mlkit.digital.ink</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MlkitEntityVersionAccessors extends VersionFactory  {

        public MlkitEntityVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>mlkit.entity.extraction</b> with value <b>16.0.0-beta6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getExtraction() { return getVersion("mlkit.entity.extraction"); }
